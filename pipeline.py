...
def main():
    ...
    if args.single_run:
        ...
        art(forms_onehot, forms, ngram_inventory, inflections, inflection_classes, language, config_string, n_runs=1, vigilances=[args.vigilance_single_run], shuffle_data=True, repeat_dataset=True, data_plot=True)
